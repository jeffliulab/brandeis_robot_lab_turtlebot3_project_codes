...
"""
The difference between the sim version is to change the color into red.
And this is the version test in the lab.
The version showned in the video, beyond this version,
is to change the color into blue,
and eliminate the obstacle avoidance function, due to the LiDar doesn't work properly.
"""
